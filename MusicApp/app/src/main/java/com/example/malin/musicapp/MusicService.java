...
public class MusicService extends Service{
    ...
    private void OngoingNotification() {
        ...
        Notification notice = new Notification(R.drawable.ic_launcher, currentTrack.getName().split(".m4a")[0] + " - " + currentTrack.getArtist(), 3);

        //This method is deprecated. Use Notification.Builder instead.
        notice.setLatestEventInfo(this, "Minify", "Click to open", pendIntent);
